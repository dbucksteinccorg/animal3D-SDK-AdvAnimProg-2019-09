...
/*
	...
	passTexcoordNormal_transform_vs4x.glsl
...
//	8) declare uniform for atlas transform
//	9) transform texcoord by atlas transform
//	10) declare varying block for data to pass along
//	11) copy resulting data to varyings
