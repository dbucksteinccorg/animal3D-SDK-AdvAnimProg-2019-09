...
void a3demo_loadGeometry(a3_DemoState *demoState)
{
	...
	const a3byte *const geometryStream = "./data/geom_data_gpro_empty.dat";
	...
	else if (!demoState->streaming || a3fileStreamOpenWrite(fileStream, geometryStream))
	{
		...
		a3proceduralCreateDescriptorPlane(displayShapes + 1, a3geomFlag_wireframe, a3geomAxis_default, 16.0f, 16.0f, 16, 16);
		for (i = 0; i < displayShapesCount; ++i)
		{
